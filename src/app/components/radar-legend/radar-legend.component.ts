...
export class RadarLegendComponent {
  readonly rings: LegendRing[] = [
    { emoji: '🔥', title: 'Adopt', description: 'My go-to stack when given the choice. Proven picks I keep returning to, project after project.' },
    ...
    { emoji: '🧊', title: 'Caution', description: 'Used it. Wouldn\'t reach for it again — outclassed, punishing in production, or just not there yet.' },
  ];
}
